  ...
  return (
    <div className="max-w-screen-2xl mx-auto min-h-[310vh] pt-32 text-black">
      <div className="h-full   ">
        <h1 className="text-[15vw] font-semibold  pl-40 ">Work</h1>
        <div className="images relative  mt-96 max-w-screen-xl min-h-[100vh] flex  left-1/2 top-1/2 -translate-x-[50%] -translate-y-[50%] items-center justify-center gap-10 ">
          <div className="left-video-with-img-1 w-1/2 h-full absolute top-32 left-10 ">
            {/* <img
            ...
            <video
              ...
              muted
              loop
              className="w-[34vw] absolute scale-[1.2]"
          ...
          <div className="right  flex flex-col gap-40 justify-between h-full absolute top-20 left-[60%] w-1/2 ">
          ...
          <div className="right gap-40 justify-between h-full absolute top-[140%] left-[40%] w-1/2 ">
            ...
            <div className="right-video-with-img w-1/2 h-full ">
              ...
              <video
                ...
                muted
                loop
                className="w-[32vw] absolute scale-[1.2]"
